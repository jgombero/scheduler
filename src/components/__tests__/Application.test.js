...
describe("Application", () => {
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    // 7. Wait until "Archie Cohen" is displayed again
    
    await waitForElement(() => getByText(container, "Josh Gomberoff"));
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    // 6. Check that the element with the error message is displayed
    await waitForElement(() => getByText(container, "Could not save appointment"));
    
    // 7. Check that we're redirected to the correct page once we click the "X" button
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    // 5. Check that the element with the error message is displayed
    await waitForElement(() => getByText(container, "Could not delete appointment"));
    
    // 6. Check that we're redirected to the correct page once we click the "X" button
    fireEvent.click(getByAltText(appointment, "Close"));
